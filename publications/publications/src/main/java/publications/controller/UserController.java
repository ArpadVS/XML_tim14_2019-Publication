...
public class UserController {
	...
	public ResponseEntity<User> unmarshall() {
		return new ResponseEntity<>(unmarshallingUtil.unmarshallFromFile("./src/main/resources/data/xml/user1.xml"),
				HttpStatus.OK);
	}
	...
	public ResponseEntity<User> update(@PathVariable(value = "id") String userId, @RequestBody User user)
			throws Exception {
	...
	public ResponseEntity<?> geAllReviewers() throws Exception {
